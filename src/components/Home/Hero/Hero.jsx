    ...
    <div className="bg font-[Inter] none">
      <div className="lg:container lg:mx-auto relative py-10 lg:py-20">
        <div className="hidden lg:block absolute right-[0px] top-36 custom-width lg:w-[900px] lg:p-[90px] bg-white shadow-lg rounded-md z-10">
          ...
          The goal of AAA Future-Edge is to empower organizations by creating a results-driven, growth-oriented workforce aligned with business strategy. 
          We achieve this by implementing comprehensive HR solutions that support every stage of the employee journey—from hiring to retirement. By aligning HR functions with business objectives, we help our clients attract, develop, and retain top talent, fostering a culture that emphasizes performance, evidence-based decision-making, and long-term growth. 
          </p>
