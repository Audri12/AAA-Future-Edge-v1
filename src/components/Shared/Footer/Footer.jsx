...
const Footer = () => {
  ...
  return (
    <div className=" bg-gradient-to-r from-white  to-[#8a8c8e]">
      <footer className="footer text-black p-5 lg:p-[118px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-14">
        <aside className="">
          <img
            ...
            alt="360d soul logo"
          />
          <div className="text-justify text-black  font-medium font-['Inter']">
          ...
          <div className="flex gap-3 my-[30px] ">
            <Link
              ...
              target="_blank"
            >
              <FaFacebookSquare className="text-4xl text-[#f58a1f] " alt="AAA facebook logo"/>

              
            </Link>
            <Link to="/" onClick={handleClick}>
            <FaSquareInstagram className="text-4xl text-[#f58a1f] " alt="AAA instagram logo"/>
            ...
            <Link
              ...
              target="_blank"
            >
              <FaLinkedin className="text-4xl text-[#f58a1f] " alt="AAA linkedin logo"/>

          
            </Link>
            <Link to="/" onClick={handleClick}>
            <FaSquareXTwitter className="text-4xl text-[#f58a1f] " alt="AAA twitter logo"/>
        ...
        <nav>
          <div className="text-black text-2xl md:text-4xl font-bold font-['Inter'] flex items-center justify-between">
            <button
          ...
          {isOpen && (
            <div className="flex flex-col gap-3 mt-[25px] md:hidden">
              <Link
                ...
                to="/IT-Strategy"
                className="link link-hover text-black  text-[18px]"
              >
                IT Strategy
              </Link>
              <Link
          ...
          {isContactOpen && (
            <div className="flex flex-col gap-3 mt-[25px] md:hidden">
              ...
              <div className="flex gap-3">
                ...
                <p className="text-black  text-[18px]">info@360dsoul.com</p>
              </div>
              <div className="flex gap-3">
                <img src={telephone} alt="telephone" />
                <p className="text-black  text-[18px]">+880 1922-000025</p>
              </div>
            </div>
          )}
          <div className="hidden md:flex flex-col gap-3 mt-[25px]">
            <p className="text-justify text-black  font-medium font-['Inter']">
              We’re just a click away, ready to discuss your business needs and
              provide the perfect IT solutions.
            </p>
            <div className="flex gap-3">
             
              <FaLocationDot className="text-4xl text-black  "alt="location" />

              <a href="" className="text-black  text-[18px]">
              Rupchaia, 3rd Floor, H 7, R 5, Rupnagar, 
Mirpur 1216, Bangladesh  
              </a>
            </div>
            <div className="flex gap-3">
            <MdEmail className="text-3xl text-black  "alt="email"/>
          
              <p className="text-black  text-[18px]">riad@aaa-fe.com
              </p>
            </div>
            <div className="flex gap-3">
            <BsFillTelephoneFill className="text-3xl text-black "alt="telephone"/>

              <p className="text-black  text-[18px]">+8801922000025</p>
            </div>
          </div>
        </nav>
      </footer>
      <h5 className="text-center text-black font-[Inter] text-sm pb-10">
